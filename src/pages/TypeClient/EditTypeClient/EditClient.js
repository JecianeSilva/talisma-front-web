...
function FormEditClient({ id, setLoading }) {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      address_code: client && client.address_code,
      address_street: client && client.address_street,
      address_number: client && client.address_number,
      address_complement: client && client.address_complement,
      address_district: client && client.address_district,
      address_city: client && client.address_city,
      address_state: client && client.address_state,
      address_reference: client && client.address_reference,
    },
  ...
  async function loadDataUser() {
    try {
      ...
      formik.setFieldValue("birthday", getDate(data.name));
      formik.setFieldValue("create_at", getDate(data.createAt));
      formik.setFieldValue("status", data.status);
      formik.setFieldValue("categories", data.categories);
      formik.setFieldValue("type", data.type);
      formik.setFieldValue("email", data.email);
      formik.setFieldValue("telefone", data.phone);
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={3} sm={6}>
              ...
              <TextField
                ...
                helperText={formik.touched.create_at && formik.errors.create_at}
              />
            </Grid>
            <Grid item xs={12} md={3} sm={6}>
              <div>
