...
function EditProduct() {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      date_validity_new: Yup.string().required("Campo Obrigatório"),
  ...
  async function loadData() {
    try {
      ...
      //   );
      // }
      formik.setFieldValue("external_code", "00000000");
      formik.setFieldValue("reference", "00000000");
      ...
      formik.setFieldValue("date_validity_new", "2022-09-20");
          ...
          <ContentBody>
            ...
            >
              ...
              >
                ...
                <Tab label="Histórico de preços" {...a11yProps(3)} disabled />
